...
*If you have any questions, feel free to reach out via LinkedIn below:*
...
End-to-end projects featuring backend API integration, databases, and user interfaces.

| Project | Type | Description | Keywords | Status | Link |
| :--- | :---: | :--- | :--- | :---: | :---: |
| **Authentication & RBAC System** | Web Application | Full-stack application for user authentication and role-based access control using JWT. | `Java` `Spring Boot` `PostgreSQL` `Angular` | 🟢 Done | [View](https://github.com/CaioHRandoli/authentication-rbac-system) |
---
...
| Project | Type | Description | Keywords | Status | Link |
| :--- | :---: | :--- | :--- | :---: | :---: |
| **2D Airplane OpenGL Simulation** | Computer Graphics | Interactive 2D scene built with PyOpenGL/GLUT featuring geometric rendering, trigonometric primitives, and keyboard controls. | `Python` `PyOpenGL` `GLUT` `Computer Graphics` | 🟢 Done | [View](https://github.com/CaioHRandoli/Computacao-Grafica_Projeto-Aviao) |
| **3D Vehicle OpenGL Simulation** | Computer Graphics | Interactive 3D car model rendered with PyOpenGL featuring custom geometric meshes, Phong lighting, and keyboard translation/rotation controls. | `Python` `PyOpenGL` `GLUT` `3D Graphics` | 🟢 Done | [View](https://github.com/CaioHRandoli/Computacao-Grafica_Projeto-Carro) |
